  ...
  return (
    <Alert.Root>
      ...
      <Alert.Portal>
        ...
        <Alert.Content className="fixed inset-0 z-50 flex h-[100dvh] items-end justify-center p-4 will-change-transform animate-in fade-in data-[state=closed]:animate-out data-[state=closed]:fade-out max-md:slide-in-from-bottom-full max-md:data-[state=closed]:slide-out-to-bottom-full md:h-[75dvh] md:items-center md:zoom-in md:data-[state=closed]:zoom-out">
